...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // post request
...
function commentFormAjaxInit() {
  var form = document.querySelector('form[name=comment]');
